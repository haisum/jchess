...
bobj.crv.params.ViewerFlexParameterAdapter = {
    ...
    hasIParamPromptUnitData : function (id) {
        return (this._iPromptUnitData[id] && this._iParamData[id] && this._iParam[id]);
    },
    ...
    _setIParamValues : function (id, valueData) {
        ...
        for (var i = 0, len = vPrompts.length; i < len; i++) {
            ...
            ctrl.updateParameter(unescape(vPrompt.name), this._convertFlexValues(vPrompt, param.valueDataType));
        }
    ...
    _unescapeFlexValue: function (fValue, type) {
        ...
        if ((fValue.value !== undefined && fValue.value !== null)){
            fValue.value = unescape(fValue.value);
            
            if (fValue.labels !== undefined && fValue.labels !== null){
               for (var i = 0, len = fValue.labels; i < len; i++) {
                   fValue.labels[i] = unescape(fValue.labels[i]);
               }
            }
       ...
       var jsValue = {};
        if ((fValue.value !== undefined && fValue.value !== null)){
            ...
            if (dIndex > -1 && fValue.labels && fValue.labels.length > dIndex){
               jsValue.desc = unescape(fValue.labels[dIndex]);
            }
            ...
            switch (type) {
                ...
                case Type.DATE_TIME:
                    ...
                    break;
                default:
                    jsValue.value = unescape(fValue.value);
                    break;
            }   
