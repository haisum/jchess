                                    ...
                                    "<tr>" +
                                        "<td valign='top' class='naviBarFrame naviFrame'>" +
                                            ...
                                            "<table style='width:100%;line-height:10px;'>" +
                                                "<tr>" +
                                                	(_ie?"<td class='dialogTitleLevel2'><label tabIndex=0>":"<td class='dialogTitleLevel2' tabIndex=0><label>") + 
...
bobj.crv.ExportUI._onSelectFormat = function() {
    ...
    if (format == 'CrystalReports' || format == 'RecordToMSExcel' || format == 'RecordToMSExcel2007' || format == 'CharacterSeparatedValues' || format == 'XML') {
        this._fromBox.setDisabled(true);
        this._toBox.setDisabled(true);
...
bobj.crv.ExportUI._getExportList = function() {	
    return "<table style='width:100%;line-height:10px;'>" +
                "<tr>" +
                (_ie?"<td class='dialogTitleLevel2'><label tabIndex=0>":"<td class='dialogTitleLevel2' tabIndex=0><label>") + 
