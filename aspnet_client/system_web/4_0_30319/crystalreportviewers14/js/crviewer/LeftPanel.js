...
bobj.crv.newLeftPanel = function(kwArgs) {
    ...
    return new bobj.crv.LeftPanel (kwArgs.id, kwArgs.hasToggleGroupTreeButton, kwArgs.hasToggleParameterPanelButton);
};

bobj.crv.LeftPanel = function(id, hasToggleGroupTreeButton, hasToggleParameterPanelButton) {
        ...
        if (this._toolPanel) {
            ...
            if (this._toolPanel.hasParameterPanel () && this.hasToggleParameterPanelButton) {
                newChild = {
                    ...
                    img : bobj.crv.ToolPanelTypeDetails.ParameterPanel.img,
            ...
            if (this._toolPanel.hasGroupTree () && this.hasToggleGroupTreeButton) {
                newChild = {
                    ...
                    img : bobj.crv.ToolPanelTypeDetails.GroupTree.img,
            ...
            this._panelHeader._closeButton.changeTooltip(L_bobj_crv_Close + " " 
            		+ bobj.crv.ToolPanelTypeDetails[this._toolPanel.initialViewType].title);
        }
    },
