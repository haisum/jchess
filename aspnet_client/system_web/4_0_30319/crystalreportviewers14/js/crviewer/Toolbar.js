...
bobj.crv.newToolbarMenu = function(kwArgs) {
    ...
    var o = newIconMenuWidget(kwArgs.id, kwArgs.icon, null, kwArgs.text, kwArgs.tooltip);
...
bobj.crv.newDrillUpButton = function(kwArgs) {
    var o = bobj.crv.newToolbarButton(MochiKit.Base.update({
        ...
        dx:0, dy:bobj.crv.allInOne.toolbarUpDy, disDx:22, disDy:bobj.crv.allInOne.toolbarUpDy, width:22, height:20
    }, kwArgs));
...
bobj.crv.newLogoIcon = function(kwArgs) {
    ...
    var o = newIconWidget(
        kwArgs.id,
        kwArgs.icon,
        function() {window.open('http://www.businessobjects.com/ipl/default.asp?destination=ViewerLogoLink&product=crystalreports&version=12.0')},
        null,
        "Crystal Reports",
        112,
        20,
...
bobj.crv.newSearchTextControl = function(kwArgs) {
    ...
    o.searchButton = newIconWidget(
        ...
        null,
        L_bobj_crv_SearchText, 
        16,16,3,bobj.crv.allInOne.toolbarSearchDy, bobj.crv.allInOne.toolbarSearchDy,3,true);
