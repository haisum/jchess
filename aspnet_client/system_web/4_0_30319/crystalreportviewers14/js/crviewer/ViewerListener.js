...
bobj.crv.ViewerListener.prototype = {
    ...
    _onRefresh: function() {
        ...
        this._request({tb:'refresh'}, bobj.crv.config.useAsync, true);
    },
    ...
    _handlePrintOrExport: function (start, end, format, isOneClickPrint) {
        ...
        var callback = null;
        var useIframe = isOneClickPDFPrinting;
        ...
        if(!paramOpts.canOpenAdvancedDialog) {
            ...
            if (this._isPromptingTypeFlex()) {    
                ...
                if (!flexAdapter.hasIParamPromptUnitData(this._name)) {
                    ...
                    this._viewer.showFlexPromptDialog(this.getServletURI());
                }
            } else {
            ...
            var callback = function (viewerListener, paramList) {
                return function () {
                    ...
                    if (paramPanel) {
                        ...
                        viewerListener._paramCtrl.setParameters(paramList);
                    }
                }
            }
