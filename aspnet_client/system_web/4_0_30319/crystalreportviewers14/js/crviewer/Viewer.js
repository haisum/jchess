...
bobj.crv.newViewer = function(kwArgs) {
    ...
    o._modalBackground = new bobj.crv.ModalBackground(kwArgs.id + "_mb");
...
bobj.crv.Viewer = {
     ...
     */
    removeFlashActivations : function() {
    ...
    _loadReportPageContent : function() {
    ...
    showFlexPromptDialog : function(servletURL) {
        var FLEXUI = bobj.crv.params.FlexParameterBridge;
    ...
    scrollToHighlighted : function() {
        ...
        if (currentView && currentView.reportPage) { //reportpage is null when setDisplayPage is false
...
bobj.crv.ModalBackground = function (id) {
    this.id = id;
};
