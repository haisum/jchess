...
// returns [String] the HTML
{
	...
	with (this)
	{
		...
		if (exp)
		{
			...
			a[i++]='<a tabindex=0 '+ onclick + ' ' + onkeydown +' href="javascript:doNothing();" role="button"><span style="display:none">' + iconTooltip + '</span><img class=trPlus src="'+expIcon+'"/></a>'
		}
		...
		a[i++]='<a href="javascript:doNothing();" '+mouseCB+ ' ' + keyCB + ' tabindex=0 '+acceptDD+' class="'+textClass+'" role="treeitem">'
