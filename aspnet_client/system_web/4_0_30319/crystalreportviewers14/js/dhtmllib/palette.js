...
// disDy    : [int - optional]      vertical offset for disabled state
{
	...
	o.arrow=newIconWidget("iconMenu_arrow_"+id,_skin+"menus.gif",IconMenuWidget_arrowClickCB,null,(_openMenuPart1+(text?text:(alt?alt:""))+_openMenuPart2),7,16,0,81,0,97,true)
	switch (menuType)
	{
...
// PRIVATE
{
...

	{
		...
		if (o.par != null && o.par.menu == _globMenuCaptured)
...

{
	...
	o.arrow=newIconWidget("arrow_"+id,_skin+"menus.gif",TextComboWidget_arrowClickCB,null,(_openMenuPart1+(tooltip?tooltip:"")+_openMenuPart2),7,16,0,81,0,97,true,true)
